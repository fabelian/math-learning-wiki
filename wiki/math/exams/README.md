...
- 생성: [`prompts/exam-prep.md`](https://github.com/fabelian/math-learning-wiki/blob/main/prompts/exam-prep.md) — 범위로 약점·오답을 필터링해 컴파일.
...
| 시험 | 범위 | 상태 | 결과 | 페이지 |
|------|------|------|------|--------|
| 종합 대비 | 미적분Ⅰ + 이차방정식 | 준비중 | - | [2026-종합대비-미적분1-이차방정식](2026-종합대비-미적분1-이차방정식.md) |
...
4. **유사 문제 보강** — [`generate-similar-problems.md`](https://github.com/fabelian/math-learning-wiki/blob/main/prompts/generate-similar-problems.md).
5. **모의 점검** — 시간 재고 풀이.
