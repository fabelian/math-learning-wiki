...
- **등록된 원본 수:** 7 (시작테스트 1·2·3·4차, 단원테스트, 진도확인테스트, 삼각함수 최고난도)
- **컴파일된 문제 수:** 65 (62 + 대수·삼각함수 최고난도 3) — 정답풀이 포함
- **대수(삼각함수) 정답풀이:** [q437](math/problems/2026-06-14-q437.md) ②·[q438](math/problems/2026-06-14-q438.md) 110·[q439](math/problems/2026-06-14-q439.md) ② — 평가원·교육청 최고난도
- **🆕 딸 학습지:** [삼각함수 최고난도 연습](math/exams/2026-06-14-삼각함수-최고난도-연습.md) — 빈칸 스캐폴딩 + 유사 변형 3문항(정답·해설 포함)
