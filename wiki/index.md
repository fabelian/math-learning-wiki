...
| 🟩 **물리** | 역학적 시스템(힘의 평형·돌림힘) 12문항 정답·해설 완료 | [physics/](physics/dashboard/weakness-map.md) |
...
- **개념:** [힘과 힘의 평형](physics/concepts/힘의평형.md) · [돌림힘과 역학적 평형](physics/concepts/돌림힘과역학적평형.md)
- **진행:** 1차 시험대비(역학적 시스템) **12문항 전체 정답·해설 완료** (q1~q12).
